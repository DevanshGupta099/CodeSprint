  ...
  return (
    <div className="tactile-card p-6 sm:p-7 select-none font-sans flex flex-col justify-between">
      ...
      <div className="flex items-center gap-3 my-2">
        <span className="text-[38px] sm:text-[44px] font-extrabold font-mono text-neutral-900 tracking-tight leading-none">
          $41,540,000
        </span>

        {/* Inline Pill Badge: ▲ 15% with green upward triangle and tactile drop shadow */}
        <div className="tactile-badge px-2.5 py-1 flex items-center gap-1 text-emerald-600 text-xs font-bold shadow-xs">
      ...
      <div className="flex flex-col gap-4 pt-1">
        {categories.map((cat, i) => (
          <div key={i} className="flex flex-col gap-1.5">
            ...
            <div className="w-full h-3.5 rounded-full bg-neutral-100 overflow-hidden p-0.5 border border-black/[0.04] shadow-inner">
      ...
      {/* Footer Readout */}
      <div className="pt-4 border-t border-neutral-100 mt-4 flex items-center justify-between text-[11px] text-neutral-400 font-medium">
        <span>Mitigation Capacity: High</span>
        <span className="text-neutral-700 font-semibold font-mono">3 Pre-Qualified Reroutes</span>
      </div>
    </div>
  );
};
