    ...
    <div className="tactile-card p-6 select-none font-sans flex flex-col justify-between">
      ...
      <div className="pb-4 border-b border-neutral-100">
        <div className="flex items-center justify-between mb-1">
          <span className="text-xs font-semibold text-neutral-500 uppercase tracking-tight">
        ...
        <div className="relative pt-4">
          ...
          <div className="absolute left-[36%] top-0 -translate-x-1/2 -translate-y-1 pointer-events-none">
            <div className="tactile-badge px-2 py-0.5 text-[9px] font-bold font-mono text-neutral-800 shadow-xs flex items-center gap-1">
