          ...
          {tiers.map((t, idx) => {
            ...
            return (
              <button
                ...
                className={`p-3 sm:p-3.5 rounded-2xl border text-left transition-all cursor-pointer flex flex-col justify-between relative overflow-hidden shrink-0 lg:shrink min-w-[150px] lg:min-w-0 ${isSelected
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <span
                      className={`text-[10px] font-mono font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${isSelected
                    ...
                    <span
                      className={`text-[10px] font-mono font-bold ${isSelected ? 'text-neutral-300 dark:text-slate-600' : 'text-neutral-400 dark:text-slate-500'
                        }`}
                    >
                  ...
                  <h4
                    className={`font-bold text-xs leading-snug line-clamp-1 ${isSelected ? 'text-white dark:text-slate-950' : 'text-neutral-900 dark:text-white'
                      }`}
                  >
                ...
                <p
                  className={`text-[10px] mt-2 line-clamp-2 ${isSelected ? 'text-neutral-300 dark:text-slate-700' : 'text-neutral-500 dark:text-slate-400'
                    }`}
                >
                  {t.desc}
                </p>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-white dark:bg-[#0B0F19] px-4 sm:px-6 py-3 sm:py-3.5 rounded-2xl border border-black/[0.06] dark:border-white/10 shadow-xs transition-colors">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            className={`px-3 py-1 rounded-full text-xs font-semibold font-mono transition-all cursor-pointer ${selectedTier === 'all' && filterMode === 'all'
          ...
          <button
            ...
            className={`px-3 py-1 rounded-full text-xs font-semibold font-mono transition-all cursor-pointer flex items-center gap-1.5 ${filterMode === 'critical'
          ...
          <button
            ...
            className={`px-3 py-1 rounded-full text-xs font-semibold font-mono transition-all cursor-pointer flex items-center gap-1.5 ${filterMode === 'spof'
